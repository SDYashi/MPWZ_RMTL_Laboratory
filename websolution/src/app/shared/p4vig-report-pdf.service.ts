...
export class P4VigReportPdfService {
  ...
  constructor() {
    // Define custom table layout globally (NOT inside doc definition)
  ...
  private buildDoc(
    ...
    return {
      ...
      images,
      header: this.headerBar(meta, images), // typed Content
      ...
      content,
      // NOTE: custom tableLayouts are registered globally in constructor
    };
  }
  ...
  private pageForRow(
      ...
      table: {
        ...
        body: [
          [
            ...
            { text: 'READING', ...lbl, fillColor: this.theme.labelBg },
          ],
    ...
    const rmtlHead = {
      text: 'TO BE FILLED BY TESTING SECTION LABORATORY (RMTL)',
      alignment: 'center',
      bold: true,
      margin: [0, 10, 0, 6],
    };
    ...
    const readFound = {
      ...
      table: {
        ...
        body: [
          [
            { text: 'READING AS FOUND — BEFORE TEST', ...lbl, fillColor: this.theme.labelBg },
            { text: 'AFTER TEST', ...lbl, fillColor: this.theme.labelBg },
          ],
